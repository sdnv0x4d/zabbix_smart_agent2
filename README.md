...
|Zabbix raw items |SMART [{#NAME}]: Self-test NVMe passed |<p>The NVMe disk is passed the SMART self-test or not.</p> |DEPENDENT |smart.nvme.disk.test[{#NAME}]<p>**Preprocessing**:</p><p>- JSONPATH: `$.smart_status.passed`</p><p>- DISCARD_UNCHANGED_HEARTBEAT: `6h`</p> |
...
|SMART [{#NAME}]: NVMe disk self-test is not passed |<p>-</p> |`last(/SMART by Zabbix agent 2/smart.nvme.disk.test[{#NAME}])="false"` |HIGH | |
